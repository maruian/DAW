...
<body>
   ...
   echo "<h3>Selecciona el aviso a detallar</h3>\n";
   echo "<table>\n";
   echo "<tr>\n";
   echo "<th>Nº Aviso</th>\n";
   ...
   echo "<th>Estado</th>\n";
   echo "</tr>\n";
   echo "<form action='ejecutar_ver_aviso.php' method='POST'>";
   foreach ($avisos->devolverAvisos() as $fila){
       ...
       echo "<tr>\n";
       echo "<td><input type='submit' value='" . $fila['idAviso'] ."' name='idAviso'></td>";
